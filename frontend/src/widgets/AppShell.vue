...
const handleWindowKeydown = (event: globalThis.KeyboardEvent) => {
  if (event.key !== 'Escape' || !isMobile.value || !mobileSidebarOpen.value) return
  closeMobileSidebar()
}

onMounted(() => {
  sidebarCollapsed.value = localStorage.getItem(props.storageKey) === 'true'
      ...
      <div class="page-content">
        <div class="route-page-stage">
          <router-view v-slot="{ Component, route: r }">
            <Transition :name="resolvePageTransitionName(r)" mode="out-in">
              <div :key="r.path" class="route-page-view">
